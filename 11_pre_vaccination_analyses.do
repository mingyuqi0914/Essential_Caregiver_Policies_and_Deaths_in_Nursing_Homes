...
clear all
set more off
log using "/PATH/Analysis_Before_Jan_2021.log", replace 
...
*** Limiting sample to observations before Jan 3rd 2021 
keep if week_number<= 15
...
* Code the relative time to treatment variable 
...
matrix V = e(V_iw)
ereturn post b V
lincom (lag_1 + lag_2 + lag_3 + lag_4 + lag_5 + lag_6 + lag_7 + lag_8 + lag_9)/9
